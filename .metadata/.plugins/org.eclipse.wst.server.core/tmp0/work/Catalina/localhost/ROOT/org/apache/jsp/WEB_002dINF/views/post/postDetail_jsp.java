 ...
 * Generated at: 2020-12-17 08:42:46 UTC
...
public final class postDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<button id=\"btnModifyReply\" class=\"btn btn-warning\" type=\"button\">Modify</button>\n");
      out.write("\t\t\t\t\t\t<button id=\"btnRemoveReply\" class=\"btn btn-danger\" type=\"button\">Remove</button>\n");
      out.write("\t\t\t\t\t\t<button id=\"btnRegisterReply\" class=\"btn btn-primary\" type=\"button\" data-dismiss=\"modal\">Register</button>\n");
      out.write("\t\t\t\t\t\t<button id=\"btnCloseReply\" class=\"btn btn-default\" type=\"button\" data-dismiss=\"modal\">Close</button>\n");
      ...
      out.write("\t\t\t\t\t\t\t+ dataGapDisplayService.displayTime(listReply[i].updateDate) \n");
      out.write("\t\t\t\t\t\t\t+ \"</small></div>\";\n");
      ...
      out.write("\t\tvar btnRegisterReply = $(\"#modalReply\");\n");
      out.write("\t\tvar btnCloseReply = $(\"#modalReply\");\n");
      out.write("\t\n");
      out.write("\t\t$(\"#btnAddReply\").on(\"click\", function(e) {\n");
      out.write("\t\t\te.preventDefault();\n");
      out.write("\t\t\t//신규 댓글 모달창 띄우기 전에 기존에 입력된 값 청소\n");
      out.write("\t\t\tmodalReply.find(\"input\").val(\"\");\n");
      out.write("\t\t\t//신규 댓글 등록시 작성 일자는 현재 시간이 db에서 자동으로 채워지니까 입력받을 필요는 없지요\n");
